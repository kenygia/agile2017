...
public interface UserDao {
    @SqlUpdate("create table users (id integer primary key autoincrement, name varchar(100) unique, alias varchar(100), email varchar(100), phone varchar(10), passwdHash varchar(64), salt varchar(64), search varchar(1024))")
